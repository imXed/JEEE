...
<div class="container py-4">
    <a class="btn btn-link ps-0 mb-3" href="${pageContext.request.contextPath}/sorties/${sortieId}">← Retour au détail</a>

    <div class="card">
        <div class="card-header">
            <h1 class="h4 mb-0">Modifier la sortie</h1>
        </div>
        <div class="card-body">
            ...
            <form:form modelAttribute="sortieForm" method="post"
                       action="${pageContext.request.contextPath}/sorties/edit/${sortieId}">
